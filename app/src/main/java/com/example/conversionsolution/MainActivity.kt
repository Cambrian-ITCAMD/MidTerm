...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val conversion_list = arrayOf("Choose One", "Mass", "Length", "Distance")
        ...
        conversion_spinner.onItemSelectedListener = object :
            ...
            override fun onItemSelected(
               ...
               //Check which conversion_spinner is selected and display other spinner according to that
                when(position){
                    1 -> {
                        conversion1.adapter = mass_adapter
                        conversion2.adapter = mass_adapter
                    }
                    2 -> {
